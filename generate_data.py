...
def generate_complex_data(num_rows=100000):
    ...
    data = {
        ...
        'Source_IP': np.random.choice(['192.168.1.1', '192.168.1.2', '192.168.1.3', '192.168.1.4'], num_rows),
        'Destination_IP': np.random.choice(['192.168.1.5', '192.168.1.6', '192.168.1.7', '192.168.1.8'], num_rows),
